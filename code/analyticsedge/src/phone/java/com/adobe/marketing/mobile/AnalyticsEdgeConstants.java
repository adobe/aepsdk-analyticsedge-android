...
final class AnalyticsEdgeConstants {
    ...
    static final class Default {
        ...
        static final int 		DEFAULT_LIFECYCLE_PAUSE_START_TIMEOUT = 1000; //ms
        static final int 		DEFAULT_LIFECYCLE_SESSION_TIMEOUT = 300000; //ms
    ...
    static HashMap<String, String> createMap() {
        ...
        map.put(EventDataKeys.Lifecycle.PREVIOUS_OS_VERSION, ContextDataKeys.OPERATING_SYSTEM);
        map.put(EventDataKeys.Lifecycle.PREVIOUS_APP_ID, ContextDataKeys.APPLICATION_IDENTIFIER);
